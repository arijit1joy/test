...
from db_util import update_scheduler_table,insert_into_metadata_Table, get_cspec_req_id, get_request_id_from_consumption_view
    ...
    try:
        ...
        for record in event['Records']:
            ...
            for s3_record in s3_body['Records']:
                ...
                request_id, schedular_status = get_request_id_from_consumption_view('J1939_Emissions', data_config_filename)
