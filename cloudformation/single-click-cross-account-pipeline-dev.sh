...
aws cloudformation deploy --stack-name da-edge-j1939-pipeline-dev --template-file ToolsAcct/code-pipeline-dev.yaml --parameter-overrides DevAccount=$DevAccount CMKARN=$CMKArn S3Bucket=$S3Bucket --capabilities CAPABILITY_NAMED_IAM --profile $ToolsAccountProfile --region us-east-1
