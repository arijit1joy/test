...
#      | EBU                   | A JSON file is created with the HB message as its content and is stored in the edge-j1939-<env> bucket under the file path NGDI/esn/device ID/yyyy/MM/dd/hb_file.json and CP Post Success Message is recorded|
#      | PT                    | Success Message                                                                                                                                                                                              |
#
...
#    When The HB is posted to the /public topic
#    Then A JSON file is created with the HB message as its content and is stored in the edge-j1939-<env> bucket under the file path ConvertedFiles/esn/deviceID/yyyy/MM/dd/hb_file.json
#    And A JSON file is created with the HB message as its content and is stored in the edge-j1939-<env> bucket under the file path NGDI/esn/device ID/yyyy/MM/dd/hb_file.json and CP Post Success Message is recorded
#
...
#    When The HB is posted to the /public topic
#    Then A JSON file is created with the HB message as its content and is stored in the edge-j1939-<env> bucket under the file path ConvertedFiles/esn/deviceID/yyyy/MM/dd/hb_file.json
#    And A JSON file is created with the HB message as its content and is stored in the edge-j1939-<env> bucket under the file path NGDI/esn/device ID/yyyy/MM/dd/hb_file.json and There is no CP post success recorded