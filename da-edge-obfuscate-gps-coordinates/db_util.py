...
def insert_into_metadata_Table(device_id, message_id, file_name, file_size, esn, config_id):
    query = insert_to_metadata_table_query(device_id, message_id, file_name, file_size, esn, config_id)
    try:
...
def insert_to_metadata_table_query(device_id, message_id, file_name, file_size, esn, config_id):
