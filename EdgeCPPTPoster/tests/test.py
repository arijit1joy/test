...
class TestEdgeCPPTPoster(unittest.TestCase):
    ...
    def test_update_scheduler_function(self):
        query = "UPDATE da_edge_olympus.scheduler SET status='Data Rx in progress' WHERE request_id='REQ1233' AND device_id='102900000000003' AND status='Config Accepted'"
        req_id = 'REQ1233'
