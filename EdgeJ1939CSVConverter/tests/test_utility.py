...
class TestUtility(unittest.TestCase):
    ...
    def test_get_logger_successful(self, mock_logging_framework):
        ...
        mock_logging_framework.assert_called_with("EdgeCSVConverter.FileName", "info")
    ...
    def test_write_to_audit_table_successful(self, mock_send_error_fn):
        ...
        """
        utility.write_to_audit_table("error-message")

        mock_send_error_fn.assert_called_with(
            "url",
            {
                "module_name": "J1939_FC",
                "error_code": "500",
                "error_message": "error-message",
                "component_name": "CSVConverter",
